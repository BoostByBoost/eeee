import {_ as s, o as t, c as e, f as l, a as o} from "./index-2be26516.js";
const I = "/haha-so.gif.mov"
  , P = "/images/game/nextImageExportOptimizer/logo-opt-750.WEBP"
  , a = "/nextImageExportOptimizer/supercell_logo.73c8fcbc-opt-128.WEBP";
const n = {}
  , r = {
    class: "styles_footer__1cZ8q"
}
  , p = {
    class: "styles_footer-bottom__4Uy_G"
}
  , d = {
    class: "styles_social__J7f1N"
}
  , v = {
    href: "http://www.facebook.com/BrawlStars",
    "aria-label": "facebook"
}
  , _ = {
    viewBox: "0 0 87 87",
  ...
  , h = {
    href: "https://twitter.com/BrawlStars",
    "aria-label": "twitter"
}
  , u = {
    width: "87",
  ...
  , g = {
    href: "https://instagram.com/BrawlStars",
  ...
  , m = {
    href: "http://supr.cl/tiktok-inbox",
    "aria-label": "tiktok"
}
  , C = {
    width: "87",
  ...
  , w = {
    href: "https://youtube.com/BrawlStars",
    "aria-label": "youtube"
}
  , M = {
    viewBox: "0 0 87 87",
...
function V(i, c) {
    return t(),
    e("footer", r, [c[7] || (c[7] = l('<div class="styles_links__PIaVg links"><div class="styles_links-wrapper__BmrYJ"><a id="footer-parens" href="https://supercell.com/en/parents/ru">Справочник для родителей</a><a id="footer-tos" href="https://supercell.com/en/terms-of-service/ru">Условия пользования</a><a id="footer-privacy-policy" href="https://supercell.com/en/privacy-policy/ru">Политика конфиденциальности</a></div></div>', 1)), o("div", p, [c[6] || (c[6] = o("div", {
        class: "styles_bottom-links__RK3oy"
    }, [o("a", {
        ...
        style: {
            ...
            "background-image": "url(/nextImageExportOptimizer/supercell_logo.73c8fcbc-opt-10.WEBP?url)"
        },
        srcSet: "/nextImageExportOptimizer/supercell_logo.73c8fcbc-opt-64.WEBP?url 1x, /nextImageExportOptimizer/supercell_logo.73c8fcbc-opt-128.WEBP?url 2x",
        src: a
    })]), o("a", {
        class: "no-track",
        href: "#"
    }, "Управление файлами cookie")], -1)), o("div", d, [o("a", v, [(t(),
    e("svg", _, c[0] || (c[0] = [o("path", {
    ...
    e("svg", y, c[5] || (c[5] = [o("g", null, [o("path", {
...
const $ = s(n, [["render", V]])
  , x = {}
  , b = {
    class: "language-dropdown-wrapper styles_language-dropdown-wrapper__z8_b8"
};
function k(i, c) {
    return t(),
    e("div", b, c[0] || (c[0] = [l('<select style="width:122px;" class="language-dropdown styles_language-dropdown__tj_as" name="locales" id="locales" aria-label="Select a language"><option value="ar">العربية</option><option value="cn">简体中文</option><option value="cnt">繁體中文</option><option value="de">Deutsch</option><option value="en">English</option><option value="es">Español</option><option value="fi">Suomi</option><option value="fr">Français</option><option value="id">Bahasa Indonesia</option><option value="it">Italiano</option><option value="jp">日本語</option><option value="kr">한국어</option><option value="ms">Bahasa Melayu</option><option value="nl">Nederlands</option><option value="no">Norsk</option><option value="pl">Polski</option><option value="pt">Português</option><option value="ru" selected="">ру́сский</option><option value="th">ไทย</option><option value="tr">Türkçe</option><option value="vi">Tiếng Việt</option></select>', 1)]))
}
const N = s(x, [["render", k]])
  , B = "/images/google-play.webp"
  , L = "/images/app-store.svg"
  , H = {};
function E(i, c) {
    return c[0] || (c[0] = l('<div class="styles_download-links-heading__0ZBue" style="font-size:24px;">Скачать Brawl Stars</div><div class="buttons"><div class="styles_download-links__y17mc download-links" data-links-amount="0"><img src="' + B + '" style="height:40px;"><img src="' + L + '"></div></div>', 2))
}
const O = s(H, [["render", E]]);
export {O as D, $ as F, N as L, I as _, P as a};
